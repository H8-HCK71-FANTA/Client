      ...
      >
        ...
        <div className="main-chat-container shadow-xl h-fit">
          ...
          >
            ...
            >
              {/* <p
                className={`${theme[currentTheme].colorTextSecondary} italic text-sm mb-5`}
              >
          ...
          >
            <form className="flex max-w-md gap-2">
              ...
              <div
                ...
                className="p-3 py-1 rounded-lg flex items-center cursor-pointer bg-pink-700 hover:bg-pink-800"
              >
